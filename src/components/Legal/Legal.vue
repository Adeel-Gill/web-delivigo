        ...
        <div class="container-fluid">
            <div class="row text-center mb-5 mt-3">
                <div class="col-md-4 btn-tab" :class="[isPolicy? 'active-btn' : '']"   id="btn1">
                    <router-link to="/privacyPolicy?docType=p"><a @click="changeActive('p')" id="cOrder"><h3>Privacy Policy</h3></a></router-link>
                </div>
                <div class="col-md-4 btn-tab" :class="[isTerms? 'active-btn' : '']"  id="btn2">
                    <router-link to="/termsAndConditions?docType=t"><a @click="changeActive('t')" id="pOrder"><h3>Terms and Conditions</h3></a></router-link>
                </div>
                <div class="col-md-4 btn-tab" :class="[isCookies? 'active-btn' : '']"  id="btn2">
                    <router-link to="/cookiesDoc?docType=c"><a @click="changeActive('c')" id="pOrder"><h3>Cookies</h3></a></router-link>
                </div>
            </div>
        </div>
...
<script>
    export default {
            ...
            changeActive(type) {
                ...
                switch(type) {
                    case 'p': {
                        ...
                        this.isCookies = true;
                        this.isPolicy = this.isTerms = false;
                        break;
                    } default: {
                        this.isPolicy = true;
                        this.isTerms = this.isCookies = false;
        ...
        mounted() {
            this.changeActive((this.$route.query.docType).charAt(0).toLowerCase())
        }
    }
</script>
