          ...
          <div class="extra-checkbox">
            <div>
              ...
              <span class="float-right">
                <input type="checkbox" name="extra" value="Bacchette" v-model="selected" />
              </span>
              <div class="clear"></div>
            </div>
            <div>
      ...
      <div class="dish-selection" @click="displayDish()">
        ...
        <div class="about-dish">
          <div class="descp-about" :class="select.class">
            ...
            <div class="buy-btn">
              <a v-if="select.btn">{{select.btn}}</a>
            </div>
            <div class="clear"></div>
          </div>
        </div>
...
<script>
import Recipes from "../../api.services/recipies";
export default {
  data: () => {
    return {
      selects: [],
